 ...
 * 控制器，对应模型Post
 * function名对应一个视图view，例如function index指view/index.ctp
 */
class PostsController extends AppController
{
	...
	public function add()
	{
		...
		{
			// 判断CakeRequest请求，当前http请求是否为posts类型
			if($this->Post->save(($this->request->data)))
			{
				// 调用Post模型，把表单提交来的数据保存到数据库
	...
	{
		// 参数id，是访问编辑页时，地址栏中带的参数
		$this->Post->id = $id;
		if($this->request->is('get'))
		{
			// 是get方式，则是从index列表点击到文章编辑页
